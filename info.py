...
API_ID = int(environ.get('API_ID', '20084097')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '2c5116e642e3eac2d7da48f35b8a7600')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8326373294:AAG-iGj8TsHenhYEJgGlwRR4Jn8tR-FbbwY")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://https://telegra.ph/file/628e7c2686d3f337e1f7b-ca29e6912a21afbfa2.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003567356521'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003565850693'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003688677819'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003551359048').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003554855383')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003400481441')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003320621870")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003542837408")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://deepikapadukone1234566_db_user:Adarsh12345@cluster0.7htiegs.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003692919921'))  # Notification of sent to your channel
